  ...
  renderData(container, data, inbox) {
    ...
    container.innerHTML = `<div class="sp-tab-content">${this.inboxMarkup(inbox)}
      ...
      <div class="sp-stats-grid sp-stats-grid-wide">
        ...
        ${this.card('Avg daily growth', (t.usersLast7Days / 7).toFixed(1), 'users per day (past week)')}
      ...
      <div class="sp-dashboard-grid sp-dashboard-grid-three">${this.list('Top user countries', data.topCountries)}${this.list('Top user interests', data.topInterests)}${this.list('Opportunity fields', data.topFields)}</div>
      <div class="sp-dashboard-grid">
